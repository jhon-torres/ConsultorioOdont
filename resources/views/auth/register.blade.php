    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <a class="ml-4 px-4 py-2 text-sm text-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 hover:bg-gray-800 hover:text-white" href="{{ route('login') }}">
                    Log in
                </a>
